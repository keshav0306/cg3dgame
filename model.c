...
Model::Mesh makeMesh(aiMesh * mesh, const aiScene * scene){
...
Model::vector<Texture> loadTextures(const aiScene * scene, aiMaterial * mat, aiTextureType type, string typeName){
    vector <Texture> textures;
...
Model::void Display(GLfloat *model, GLfloat * transform, GLfloat * view){
